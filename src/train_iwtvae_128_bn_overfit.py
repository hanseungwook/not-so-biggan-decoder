...
import numpy as np
from vae_models import WT, wt, IWT, iwt, IWTVAE_128_3Masks_1
...
if __name__ == "__main__":
    ...
    iwt_model = IWTVAE_128_3Masks_1(z_dim=args.z_dim, num_iwt=args.num_iwt)
    ...
    log_dir = os.path.join(args.root_dir, 'runs/iwtvae128_3masks_overfit_in_{}'.format(args.config))
