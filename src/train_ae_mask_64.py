...
if __name__ == "__main__":
    ...
    img_output_dir = os.path.join(args.root_dir, 'wtvae_results/image_samples/aemask64_{}'.format(args.config))
    model_dir = os.path.join(args.root_dir, 'wtvae_results/models/aemask64_{}/'.format(args.config))
