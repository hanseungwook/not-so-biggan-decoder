...
import numpy as np
from vae_models import WT, wt, IWT, iwt, AE_Mask_512, AE_Mask_512_1
...
if __name__ == "__main__":
    ...
    model = AE_Mask_512_1(z_dim=args.z_dim)
    ...
    img_output_dir = os.path.join(args.root_dir, 'wtvae_results/image_samples/aemask512_{}'.format(args.config))
    model_dir = os.path.join(args.root_dir, 'wtvae_results/models/aemask512_{}/'.format(args.config))
