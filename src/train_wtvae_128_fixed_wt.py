...
import numpy as np
from vae_models import WTVAE_128_FixedWT, wt
from wt_datasets import CelebaDatasetPair
from trainer import train_wtvae_128_fixed_wt
...
if __name__ == "__main__":
    ...
    wt_model = WTVAE_128_FixedWT(z_dim=args.z_dim, num_wt=args.num_wt)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_wtvae_128_fixed_wt(epoch, wt_model, optimizer, train_loader, train_losses, args, writer)
