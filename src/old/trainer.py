...
# Taking in low frequency IWT'ed image to produce mask in autoencoder (32 => 128, but using 512 images)
def train_iwtae_iwtmask128(epoch, wt_model, iwt_model, optimizer, iwt_fn, train_loader, train_losses, args, writer):
    # toggle model to train mode
    iwt_model.train()
    train_loss = 0
